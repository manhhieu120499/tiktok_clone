...
export const HomeIconIsActive = ({ width = '3.2rem', height = '3.2rem', className }) => {
    const classes = cx(className);
    return (
        <svg
            className={classes}
...
export const FollowIconIsActive = ({ width = '3.2rem', height = '3.2rem', className }) => {
    const classes = cx(className);
    return (
        <svg
            className={classes}
...
export const LiveIconIsActive = ({ width = '3.2rem', height = '3.2rem', className }) => {
    const classes = cx(className);
    return (
        <svg
            className={classes}
...
export const MessageCommentsIcon = ({ width = '2.4rem', height = '2.4rem', className }) => {
    const classes = cx(className);
    return (
        <svg
            className={classes}
...
export const BookMarkIcon = ({ width = '2.4rem', height = '2.4rem', className }) => {
    const classes = cx(className);
    return (
        <svg className={classes} xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill="currentColor">
            <path
                fill="currentColor"
...
export const EmbededIcon = ({ width = '2.6rem', height = '2.6rem', className }) => {
    const classes = cx(className);
    return (
        <svg
            className={classes}
...
export const SendLinkIcon = ({ width = '2.6rem', height = '2.6rem', className }) => {
    const classes = cx(className);
    return (
        <svg
            className={classes}
...
export const WhatAppIcon = ({ width = '2.6rem', height = '2.6rem', className }) => {
    const classes = cx(className);
    return (
        <svg
            className={classes}
...
export const ArrowUpIcon = ({ width = '2.6rem', height = '2.6rem', className }) => {
    const classes = cx(className);
    return (
        <svg
            className={classes}
...
export const ArrowDownIcon = ({ width = '2.6rem', height = '2.6rem', className }) => {
    const classes = cx(className);
    return (
        <svg
            className={classes}
...
export const MusicNoteIcon = ({ width = '1.5rem', height = '1.5rem', className }) => {
    const classes = cx(className);
    return (
        <svg
            className={classes}
...
export const HeartIconTransparent = ({ width = '2rem', height = '2rem', className }) => {
    const classes = cx(className);
    return (
        <svg
            className={classes}
...
export const ArrowDownIconSmall = ({ width = '1rem', height = '1rem', className }) => {
    const classes = cx(className);
    return (
        <svg
            className={classes}
...
export const TagIcon = ({ width = '2rem', height = '2rem', className }) => {
    const classes = cx(className);
    return (
        <svg
            className={classes}
