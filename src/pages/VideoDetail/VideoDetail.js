                    ...
                    <div className={cx('info_video')}>
                        <div className={cx('heading')}>
                            ...
                            <div className={cx('user_post')}>
                                <p className={cx('user_name')}>{data.state.username}</p>
                                <span className={cx('nick_name')}>{data.state.nickname}</span>
                                <span className={cx('time_post')}>{data.state.timePost}</span>
                            </div>
                        ...
                        <div className={cx('music_link')}>
                            <MusicNoteIcon />
                            <p className={cx('link')}>{data.state.music_link}</p>
                        </div>
                    </div>
